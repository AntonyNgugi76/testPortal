...
class LoanApplication extends StatefulWidget {
  ...
  const LoanApplication({Key? key, required this.token}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
              child: FutureBuilder<LoanApplicationModel>(
                  future: _apiServices.getAllLoans(widget.token),
                  builder:
                      (context, AsyncSnapshot<LoanApplicationModel> snapshot) {
                        ...
                        child: DataTable(
                          ...
                          rows: List<DataRow>.generate(
                              ...
                              (index) => DataRow(
                                    cells: [
                                      DataCell(Text(loans
                                          .loans![index].user!.firstName!)),
                                      DataCell(
                                          Text(loans.loans![index].status!)),
                                      DataCell(Text(loans.loans![index].amount!
                                          .toString())),
                                      DataCell(Text(loans
                                          .loans![index].appliedOn!
                                          .toString())),
                                      DataCell(Text(loans
                                          .loans![index].survey!.howAreYou
                                          .toString())),
                                      DataCell(
                                        Row(
                                          children: [
